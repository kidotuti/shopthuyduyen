      ...
      productElement.innerHTML = `
          <div class="product-content">
            ...
            <div class="product-info">
              ...
              <p class="product-price" style="font-size:0.89rem">${
                product.retailPrice
              }</p>
              <p class="product-price" style="color: var(--carribean-green);font-weight:bold;font-size:1.2rem">${
                product.salePrice
              }đ</p>
              <p class="product-price" style="font-size:0.8rem;text-transform: uppercase;">${
                product.type
              }</p>
            </div>
